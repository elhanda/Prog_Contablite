...
Public Class Rapport_Bilan1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prog_Contablite.Rapport Bilan1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRapport_Bilan1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rapport_Bilan1 = New Rapport_Bilan1()
        rpt.Site = Me.Site
        Return rpt
    End Function
