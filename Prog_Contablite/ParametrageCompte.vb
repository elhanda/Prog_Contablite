...
Public Class ParametrageCompte
    ...
    '    'chaineDeConnexion = "Data Source=DESKTOP-C826HA4\SQLEXPRESS;Initial Catalog=D:\PROG_CONTABILITE\PROG_CONTABLITE\DATA\BASE_COMPTA_001.MDF;Integrated Security=True"
    ...
    '    'chaineDeConnexion = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=E:\PROG_CONTABLITE\PROG_CONTABLITE\DATA\BASE_COMPTA_" & Access.n2 & ".MDF;Integrated Security=True"
    ...
    '        MessageBox.Show("Erreur de connexion." + ex.Message, "text", MessageBoxButtons.YesNo, MessageBoxIcon.Information)
