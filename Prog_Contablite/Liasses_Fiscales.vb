...
Public Class Liasses_Fiscales
    ...
    Sub Aff(Lign, Column, annee, report)
        Dim V1 As Integer
        Dim v2 As Integer
        Dim i As Integer
        ...
        Try
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                adapt1.Fill(ds)
                'MessageBox.Show("Ligne  :" + CStr(Lign) + " Colonne  : " + CStr(Column) + " annee :" + CStr(an))
    ...
    Sub strinfg(code, report)
        ...
        Try
            Dim req As String
            req = String.Format(" Select S_pat, S_Nom, S_adr1  from Fsociete where S_code = '" & code & "'")        ', New FileInfo(Application.ExecutablePath).DirectoryName)
            cmd = New SqlCommand(req, con)
...
", New FileInfo(Application.ExecutablePath).DirectoryName, New FileInfo(Application.ExecutablePath).DirectoryName)
    ...
    Private Sub Liasses_Fiscales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            strinfg("001", report)
            Dim req1 As String
            req1 = (" select S_pat,S_Nom,S_adr1  from Fsociete where S_code =  " & Access.n2 & " ")        ', New FileInfo(Application.ExecutablePath).DirectoryName)
            cmd = New SqlCommand(req1, con)
            Dim adaptr2 As SqlDataAdapter
            adaptr2 = New SqlDataAdapter(cmd)
            Dim dt = New DataTable()
        ...
        Try
            ...
            For index = 1 To 45
                ...
                For index1 = 1 To 4
                    ...
                    report.SetParameterValue("E1_zone" & index & "" & index1, 0)
                ...
                For index1 = 1 To 4
                    ...
                    Select Case index1
                        ...
                        Case 3
                            Aff(index, index1, exec_proc.n1, report)
                        Case 4
                            Aff(index, index1, exec_proc.n1 - 1, report)
                    End Select
        ...
        Try
            For index = 1 To 40
                ...
                aff1(index, exec_proc.n1, report)
