...
Public Class EditionjournalCR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prog_Contablite.EditionjournalCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEditionjournalCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EditionjournalCR = New EditionjournalCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
