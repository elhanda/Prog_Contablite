...
Public Class GrandLivreCR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prog_Contablite.GrandLivreCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGrandLivreCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GrandLivreCR = New GrandLivreCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
