...
Public Class Bilan_test_5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prog_Contablite.Bilan_test_5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBilan_test_5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bilan_test_5 = New Bilan_test_5()
        rpt.Site = Me.Site
        Return rpt
    End Function
