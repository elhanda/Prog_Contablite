...
Public Class affichetutoseulCR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prog_Contablite.affichetutoseulCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedaffichetutoseulCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As affichetutoseulCR = New affichetutoseulCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
