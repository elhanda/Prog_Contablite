Public Class Form_Choix
    ...
    'Public Shared mF As Form1

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        '  THOST.Text = My.Computer.Name
    ...
    Private Sub Form_Choix_Resize(sender As Object, e As EventArgs) Handles Me.Resize
